# UniFi Dashboard Telemetry 0.8.0-rc1
...
The companion template deliberately does not redefine the API macros. It expects the host to already inherit:
...
3. `dpi` returns one or more applications when Traffic Identification/DPI is enabled.
