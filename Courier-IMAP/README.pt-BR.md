...
> Versao de desenvolvimento: 1.1.0
>
> Manutencao da documentacao: quando este README em portugues for atualizado, atualize tambem o `README.md`.

Projeto de template Zabbix para monitorar logins Courier-IMAP e Courier-POP3 em FreeBSD por UserParameters do Zabbix agent. Este repositorio mantem o export XML original para Zabbix 3.2 em um diretorio versionado de templates e organiza scripts, configuracao do agent, validacao e changelogs no layout atual do repositorio.
...
- Zabbix server compativel com export de template 3.2.
...
6. Importe `templates/3.2/Template_Courier_IMAP_3.2.xml` no Zabbix.
...
- `templates/3.2/Template_Courier_IMAP_3.2.xml` e o export legado preservado para este projeto.
